...
def ot_data(hic_matrix: np.ndarray, trussart_hic: np.ndarray, rng) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
...
def transport(Xs: np.ndarray, Xt: np.ndarray, X1: np.ndarray, X2: np.ndarray, hic_shape: np.ndarray, trussart_shape: np.ndarray) -> Tuple[np.ndarray, np.ndarray]:
