...
def plot_losses(losses, train_biological_losses_all_epochs, test_biological_losses_all_epochs, train_kabsch_losses_all_epochs, test_kabsch_losses_all_epochs, trussart_test_kabsch_losses_all_epochs, train_distance_losses_all_epochs, test_distance_losses_all_epochs):
    ...
    axs[1,0].plot(trussart_test_kabsch_losses_all_epochs, label='Kabsch Distance Trussart')
    axs[1,0].legend()
    ...
    axs[1,1].plot(trussart_test_kabsch_losses_all_epochs, label='Kabsch Distance Trussart')
    axs[1,1].legend()
...
def plot_true_pred_structures(x_pred, y_pred, z_pred, x_true, y_true, z_true, colorscale1, colorscale2, color1, color2):
...
def plot_hist_kabsch_distances(test_size, test_true_structures, test_pred_structures, embedding_size):
    kabsch_distances = []
...
def plot_pred_conf(trussart_pred_structure_superposed, pldts, color):
    ...
    fig.add_trace(
        go.Scatter3d(
        x=trussart_pred_structure_superposed[:,0], y=trussart_pred_structure_superposed[:,1], z=trussart_pred_structure_superposed[:,2], opacity=0.7,
        marker=dict(
            size=6,
            color=pldts,
            colorscale=color,
